...
# Now creating Signal in Django so when new user create i will add a new row in HOD, STAFF, STUDENT with its ID in admin_id column
from django.dispatch import receiver
from django.db.models.signals import post_save
...
@receiver(post_save, sender=CustomUser)
def save_user_profile(sender, instance, **kwrgs):
    if instance.user_type == 1:
